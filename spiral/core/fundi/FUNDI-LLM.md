...
signed offsets. Small, but real tasks:
    ...
    spiral ai ask "der wochentag von heute" --profile fundi
    spiral ai ask "weekday of 2026-12-24" --profile fundi

    # deadlines and countdowns
    spiral ai ask "count the days from today until 2026-12-24" --profile fundi
    spiral ai ask "add 90 days to 2026-06-08" --profile fundi
    spiral ai ask "das datum 14 tage vor 2026-12-24" --profile fundi

    # planning
    spiral ai ask "die kalenderwoche von heute plus 30 tagen" --profile fundi
    spiral ai ask "die mondphase am 2000-01-06" --profile fundi

    # relative words, chains of them, and month/year shifts
    spiral ai ask "welches datum ist übermorgen" --profile fundi
    spiral ai ask "the week number of next month" --profile fundi
    ...
    spiral ai ask "today minus 1 week" --profile fundi
    spiral ai ask "2026-06-08 plus 3 weeks" --profile fundi

    # days between today and a date relative to today
    spiral ai ask "count the days from today until tomorrow" --profile fundi
    spiral ai ask "tage von heute bis naechste woche" --profile fundi
...
`python -m spiral.core.fundi.train`, and check the reported accuracy
