...
``infer.py``). Run ``python -m spiral.core.fundi.train`` from the project
root; the weights land in ``spiral/core/fundi/weights.npz``.
...
from spiral.core.fundi import tokenizer
