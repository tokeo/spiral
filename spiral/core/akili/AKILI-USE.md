...
```shell
spiral ai ask "append_file hello" --agent guarded
```
...
```shell
spiral ai ask "calc 2 + 3" --agent audited
```
...
```shell
spiral ai ask "calc 6 * 7" --agent guarded --json
```
...
```shell
spiral ai ask "text len wir sehen uns in 7 tagen" --profile codermock
```
...
```shell
spiral ai ask "calc 2 + 3" --profile akili --json
```
...
```shell
spiral ai ask "what is the capital of france" --profile akili
```

```shell
spiral ai ask "wann ist ostern" --profile akili
```

```shell
spiral ai ask "heute plus -2 tage" --profile akili
```
...
```shell
spiral ai ask "erinnere mich in 3 tagen an annas geburtstag" --profile akili
```
...
```shell
spiral ai ask "heute plus 12345 tage" --profile akili
```
...
```shell
spiral ai ask "welcher wochentag ist nicht heute sondern morgen" --profile akili
```
...
```shell
spiral ai ask "heute plus 2 tage plus 3 wochen" --profile akili
```
...
```shell
spiral ai ask "erinnere mich in 3 tagen an annas geburtstag" --profile akili --json
```
