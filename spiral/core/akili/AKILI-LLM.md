...
signed offsets. Small, but real tasks:
    ...
    spiral ai ask "der wochentag von heute" --profile akili
    ...
    # planning
    spiral ai ask "die kalenderwoche von heute plus 30 tagen" --profile akili
    spiral ai ask "die mondphase am 2000-01-06" --profile akili

    # relative words, chains of them, and month/year shifts
    spiral ai ask "welches datum ist übermorgen" --profile akili
    spiral ai ask "the week number of next month" --profile akili
    ...
    spiral ai ask "today" --profile akili
    spiral ai ask "heute" --profile akili

    # weeks are seven-day shifts (no add_weeks tool)
    spiral ai ask "today minus 1 week" --profile akili
    ...
    spiral ai ask "tage von heute bis naechste woche" --profile akili

    # and the three-step chains, its signature move
    spiral ai ask "the weekday of today plus 14 days" --profile akili
    spiral ai ask "der wochentag von vor 2 tagen" --profile akili
...
The ```--no-minus``` switch is a built-in ablation experiment:
    ...
    python -m spiral.core.akili.train             # with minus teaching
    python -m spiral.core.akili.train --no-minus  # without
...
(```python -m spiral.core.akili.data --no-minus```).
