"""
Truncate transformer example for the Spiral ai agent.
...
ai:
  transformers:
    truncate:
      type: spiral.core.ai.transformers.truncate.SpiralAiTruncateTransformer
      options:
...
class SpiralAiTruncateTransformer(TokeoAiTruncateTransformer):
    """
