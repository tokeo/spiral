...
def add_SpiralServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler('spiral.Spiral', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('spiral.Spiral', rpc_method_handlers)
...
class Spiral(object):
    ...
    def CountWords(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/spiral.Spiral/CountWords',
            spiral_dot_core_dot_grpc_dot_proto_dot_spiral__pb2.CountWordsRequest.SerializeToString,
