...
Train-first: the weights are a project asset created by you. Run
    ...
    make fundi-train        # or: python -m spiral.app.fundi.train
...
`python -m spiral.app.fundi.data` to print samples.
...
`python -m spiral.app.fundi.data`, and check the reported accuracy
