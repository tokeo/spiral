...
``infer.py``). Run ``python -m spiral.app.fundi.train`` from the project
root; the weights land in ``spiral/app/fundi/weights.npz``.
"""
...
from spiral.app.fundi import tokenizer
from spiral.app.fundi.data import dataset
