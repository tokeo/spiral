...
from ..core.grpc import spiral_servicer
...
class GrpcCallController(Controller):
    ...
    class Meta:
        ...
        epilog = 'Example: spiral grpc count-words --url value'
    ...
    def count_words(self):
        ...
        with grpc.insecure_channel(self.app.config.get('grpc', 'url')) as channel:
            ...
            response = stub.CountWords(spiral_pb2.CountWordsRequest(url=self.app.pargs.url))
