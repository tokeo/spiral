...
The Spiral API Reference

Complete OpenAPI documentation for Spiral services and endpoints.
...
This API provides programmatic access to Spiral services and data.
...
def get_openapi_custom():
    ...
    openapi_schema = get_openapi(
        ...
        title='Spiral OpenAPI Documentation',
        summary=SUMMARY,
        ...
        # Contact dict
        contact=dict(
            name='Tom Freudenberg',
            url=None,
            email='th.freudenberg@gmail.com',
        ),
        # License dict
        license_info=dict(
            name='MIT',
