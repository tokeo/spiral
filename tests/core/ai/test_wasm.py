"""
Wasm sandbox tests for the Spiral project's two python-exec tools.
...
def test_spiral_wasm_memory_cap_is_hard():
...
_PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(spiral.__file__)))
...
class SpiralWasmTestApp(SpiralTest):
...
def test_spiral_untrusted_exec_in_wasm_guest():
...
def test_spiral_trusted_exec_in_wasm_guest():
