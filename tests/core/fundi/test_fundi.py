...
def test_spiral_fundi_data_contract():
    ...
    from spiral.core.fundi.data import dataset, _LEXICON
    from spiral.core.fundi.dsl import DOMAIN, NOMATCH, Constrainer, parse
